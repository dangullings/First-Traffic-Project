...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener, ItemListener {
    ...
    static JCheckBoxMenuItem cbMenuItem1;
    static JCheckBoxMenuItem cbMenuItem2;
    ...
    private static void init() {
        ...
        frame.setTitle("Gullings_Final_TrafficSimulation");
    ...
    private static JMenuBar createMenuBar() {
		...
		JMenuItem menuItem = new JMenuItem("Reset Simulation");
		menuItem.addActionListener(std);
		menuItem.setActionCommand("Reset Simulation");
		menu.add(menuItem);
		...
		menu.addSeparator();
		cbMenuItem1 = new JCheckBoxMenuItem(" Feed in vehicles");
		cbMenuItem1.setActionCommand("Feed in vehicles");
		cbMenuItem1.setSelected(true);
		cbMenuItem1.addItemListener(std);
		menu.add(cbMenuItem1);

		cbMenuItem2 = new JCheckBoxMenuItem("Overlay");
		cbMenuItem2.setActionCommand("Overlay");
		cbMenuItem2.setSelected(false);
		cbMenuItem2.addItemListener(std);
		menu.add(cbMenuItem2);
		
		menu.addSeparator();
		JMenu submenuAS = new JMenu("Stoplights");
		
		menuItem = new JMenuItem("Auto Smart");
		menuItem.setActionCommand("Auto Smart");
		menuItem.addActionListener(std);
		submenuAS.add(menuItem);
		
		menuItem = new JMenuItem("Auto Interval");
		menuItem.setActionCommand("Auto Interval");
		menuItem.addActionListener(std);
		submenuAS.add(menuItem);
		...
		menuItem = new JMenuItem("Citizen");
		menuItem.addActionListener(std);
		menuItem.setActionCommand("Citizen");
		submenu.add(menuItem);
		menuItem = new JMenuItem("Bus");
		menuItem.addActionListener(std);
		menuItem.setActionCommand("Bus");
		submenu.add(menuItem);
		menuItem = new JMenuItem("Cop");
		menuItem.addActionListener(std);
		menuItem.setActionCommand("Cop");
		submenu.add(menuItem);
		menuItem = new JMenuItem("Fire Truck");
		menuItem.addActionListener(std);
		menuItem.setActionCommand("Fire Truck");
		submenu.add(menuItem);
		menuItem = new JMenuItem("Ambulance");
		menuItem.addActionListener(std);
		menuItem.setActionCommand("Ambulance");
		submenu.add(menuItem);
    ...
    public void actionPerformed(ActionEvent e) {
		if ("Reset Simulation".equals(e.getActionCommand())) 
			...
			System.exit(0);
		else if (("Auto Smart".equals(e.getActionCommand()))||("Auto Interval".equals(e.getActionCommand()))||("Manual".equals(e.getActionCommand())))
			Main.changeStoplights(e.getActionCommand());
		else
			Main.changeViewType(e.getActionCommand());
    }
    ...
    public void itemStateChanged(ItemEvent e) {
		...
		if (source == cbMenuItem1){
	    	Main.checkboxResettingCars(true);
	    if (e.getStateChange() == ItemEvent.DESELECTED)
	    	Main.checkboxResettingCars(false);
		}
	    if (source == cbMenuItem2){
	    	Main.checkboxOverlay(true);
	    if (e.getStateChange() == ItemEvent.DESELECTED)
	    	Main.checkboxOverlay(false);
	    }
	}
   /*************************************************************************
